-- ============================================================
-- توسيع كتالوج الصلاحيات (تظهر تلقائيًا في شاشة الصلاحيات)
-- نفّذ مرة واحدة في SQL Editor ثم حدّث صفحة roles.html
-- ============================================================
...
-- قيم افتراضية متوازنة (يمكن تغييرها من الشاشة لاحقًا)
-- stage_manager
...
SELECT key, label_ar, category, sort_order
